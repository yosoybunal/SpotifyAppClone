...
final class AuthManager {
    ...
    struct Constants {
        ...
        static let clientID = "7e464dfa8bc8472c80c2e655271abf9e"
        static let clientSecret = "3fb550266d9144ee9709aa45e7fa1ed5"
    ...
    public var signInURL: URL? {
        ...
        let redirectURI = "https://twitter.com/bonderfulapp"
    ...
    public func exchangeCodeForToken(code: String, completion: @escaping((Bool) -> Void)) {
        ...
        components.queryItems = [
            ...
            URLQueryItem(name: "redirect_uri", value: "https://twitter.com/bonderfulapp")
        ]
...
//            print("Failure to get base64")
        ...
        let task = URLSession.shared.dataTask(with: request) { [weak self] data, _, error in
            guard let data = data,
                  error == nil else { completion(false)
                    return
            }
